...
//		//---------------------------------------------------
 		...
 		daoService.makeDeposit("Checking Account", 400.00);
 		daoService.makeDeposit("Checking Account", 500.00);
 		daoService.makeDeposit("Checking Account", 300.00);
 		daoService.makeDeposit("Checking Account", 200.00);
 		daoService.makeDeposit("Checking Account", 100.00);
 		daoService.makeDeposit("Checking Account", 800.00);
